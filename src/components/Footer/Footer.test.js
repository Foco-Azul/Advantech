...
test('Que todos los enlaces tengan atributo href y no esté vacío', () => {
  render(
    <UserProvider>
      <Footer />
    </UserProvider>
...
test('Que todos los enlaces de redes abran en distinta pagina', () => {
    render(
      <UserProvider>
        <Footer />
      </UserProvider>
 ...
 socialLinks.forEach((link) => {
  ...
  test('Que todos los enlaces se abran en la misma pagina, excepto las redes sociales y el enlace de Monitorio uptime', () => {
    render(
      <UserProvider>
        <Footer />
      </UserProvider>
  ...
  test('Renderizar el componente Footer', () => {
    render(
        <UserProvider>
            <Footer />
        </UserProvider>
