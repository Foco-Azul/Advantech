        ...
        <section className="seccion-productos">
            <div className="productos-contenido">
                <div className="productos-izq">
                    ...
                    <p>Contamos con productos que te permitirán obetener los datos necesarios para clasificar clientes potenciales en grupos específicos en función de datos demográficos, intereses y comportamientos.</p>
                </div>
                <div className="productos-der">
                    <div className="acordeon">
                        <div className="acordeon-cabecera">
