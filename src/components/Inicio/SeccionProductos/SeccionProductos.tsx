    ...
    <section className="seccion-productos">
      <div className="productos-contenido">
        ...
        <div className="productos-der">
          ...
          <video src="https://admin.advantech.com.ec/uploads/por-busqueda.mkv" width={600} controls></video>
          </div>
          <div  className={'pestaña-contenido ' + (activeTab === 'DATOS POR DESCARGA' ? 'contenido-activo' : '')}>
            <video src="https://admin.advantech.com.ec/uploads/por-descarga.mkv" width={600} controls></video>
          </div>
